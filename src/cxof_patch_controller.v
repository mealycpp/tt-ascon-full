/*
 * cxof_patch_controller.v -- ASCON-CXOF128 controller for patch-fed sponge core.
 *
 * Rule:
 *   - This controller never builds a 320-bit permutation input.
 *   - It sends 64-bit patches to x0 and starts permutations.
 *   - It preserves the existing CXOF chain behavior with 4x64 feedback FIFO.
 */

`default_nettype none

module cxof_patch_controller (
    input  wire         clk,
    input  wire         rst_n,
    ...
    localparam S_LOAD_IV     = 5'd2;
    localparam S_INIT_KICK   = 5'd3;
    localparam S_INIT_WAIT   = 5'd4;
    localparam S_LEN_PATCH   = 5'd5;
    localparam S_LEN_PERM    = 5'd6;
    localparam S_LEN_WAIT    = 5'd7;
    localparam S_CS_PULL     = 5'd8;
    localparam S_WORD_PREP   = 5'd9;
    localparam S_CS_PATCH    = 5'd10;
    localparam S_CS_PERM     = 5'd11;
    localparam S_CS_WAIT     = 5'd12;
    localparam S_MSG_PULL    = 5'd13;
    localparam S_CHAIN_FETCH = 5'd14;
    localparam S_MSG_PATCH   = 5'd15;
    localparam S_MSG_PERM    = 5'd16;
    localparam S_MSG_WAIT    = 5'd17;
    localparam S_SQ_EMIT     = 5'd18;
    localparam S_SQ_PERM     = 5'd19;
    localparam S_SQ_WAIT     = 5'd20;
