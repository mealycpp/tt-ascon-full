...
module tb_sdmc_aead128_ad1;
    ...
    wire [TOKEN_W-1:0] token4 = {1'b1, `SDMC_TOK_AD,    4'd1, 64'h0000_0000_0000_0030};
    ...
    initial begin
        $dumpfile("tb_sdmc_aead128_ad1.vcd");
        $dumpvars(0, tb_sdmc_aead128_ad1);
        ...
        if (tag !== 128'hc07556b311abd685a2098ae14f67cbcc) begin
            $display("FAIL tag mismatch got=%h", tag);
            $finish;
        end

        $display("PASS sdmc_aead128_ad1");
        $finish;
    end
