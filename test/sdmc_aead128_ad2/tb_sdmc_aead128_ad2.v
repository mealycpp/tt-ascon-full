...
module tb_sdmc_aead128_ad2;
    ...
    wire [TOKEN_W-1:0] token4 = {1'b1, `SDMC_TOK_AD,    4'd2, 64'h0000000000003130};
    ...
    initial begin
        $dumpfile("tb_sdmc_aead128_ad2.vcd");
        $dumpvars(0, tb_sdmc_aead128_ad2);
        ...
        if (tag !== 128'h82a7ccbb0e46d4fd9cdfc45015195bf6) begin
            $display("FAIL tag mismatch got=%h exp=%h", tag, 128'h82a7ccbb0e46d4fd9cdfc45015195bf6);
            $finish;
        end

        $display("PASS sdmc_aead128_ad2");
        $finish;
    end
