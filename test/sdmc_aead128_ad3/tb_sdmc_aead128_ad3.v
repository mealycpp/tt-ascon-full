...
module tb_sdmc_aead128_ad3;
    ...
    wire [TOKEN_W-1:0] token4 = {1'b1, `SDMC_TOK_AD,    4'd3, 64'h0000000000323130};
    ...
    initial begin
        $dumpfile("tb_sdmc_aead128_ad3.vcd");
        $dumpvars(0, tb_sdmc_aead128_ad3);
        ...
        if (tag !== 128'h429f61b3706c613089dad42c7dcf27d1) begin
            $display("FAIL tag mismatch got=%h exp=%h", tag, 128'h429f61b3706c613089dad42c7dcf27d1);
            $finish;
        end

        $display("PASS sdmc_aead128_ad3");
        $finish;
    end
