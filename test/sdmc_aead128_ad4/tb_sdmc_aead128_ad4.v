...
module tb_sdmc_aead128_ad4;
    ...
    wire [TOKEN_W-1:0] token4 = {1'b1, `SDMC_TOK_AD,    4'd4, 64'h0000000033323130};
    ...
    initial begin
        $dumpfile("tb_sdmc_aead128_ad4.vcd");
        $dumpvars(0, tb_sdmc_aead128_ad4);
        ...
        if (tag !== 128'hdf824ccc13d9c9976bedb5522ea90b00) begin
            $display("FAIL tag mismatch got=%h exp=%h", tag, 128'hdf824ccc13d9c9976bedb5522ea90b00);
            $finish;
        end

        $display("PASS sdmc_aead128_ad4");
        $finish;
    end
