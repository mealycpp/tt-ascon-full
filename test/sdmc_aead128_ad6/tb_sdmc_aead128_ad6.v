...
module tb_sdmc_aead128_ad6;
    ...
    wire [TOKEN_W-1:0] token4 = {1'b1, `SDMC_TOK_AD,    4'd6, 64'h0000353433323130};
    ...
    initial begin
        $dumpfile("tb_sdmc_aead128_ad6.vcd");
        $dumpvars(0, tb_sdmc_aead128_ad6);
        ...
        if (tag !== 128'hd5a40aadfd3b1a9bb8936ed546bccc51) begin
            $display("FAIL tag mismatch got=%h exp=%h", tag, 128'hd5a40aadfd3b1a9bb8936ed546bccc51);
            $finish;
        end

        $display("PASS sdmc_aead128_ad6");
        $finish;
    end
