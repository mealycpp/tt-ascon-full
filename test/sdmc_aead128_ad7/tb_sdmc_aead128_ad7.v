...
module tb_sdmc_aead128_ad7;
    ...
    wire [TOKEN_W-1:0] token4 = {1'b1, `SDMC_TOK_AD,    4'd7, 64'h0036353433323130};
    ...
    initial begin
        $dumpfile("tb_sdmc_aead128_ad7.vcd");
        $dumpvars(0, tb_sdmc_aead128_ad7);
        ...
        if (tag !== 128'hab658fa6c4ea5e26c671e073d5bb8ab3) begin
            $display("FAIL tag mismatch got=%h exp=%h", tag, 128'hab658fa6c4ea5e26c671e073d5bb8ab3);
            $finish;
        end

        $display("PASS sdmc_aead128_ad7");
        $finish;
    end
