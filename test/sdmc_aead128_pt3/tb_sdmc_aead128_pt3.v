...
module tb_sdmc_aead128_pt3;

    localparam TOKEN_W = `SDMC_TOKEN_W;
    localparam OUT_BYTES = 19;
    ...
    wire [TOKEN_W-1:0] token4 = {1'b1, `SDMC_TOK_MSG,   4'd3, 64'h0000000000222120};
    ...
    always @(posedge clk) begin
        if (!rst_n || clear) begin
            ...
            if (out_idx == 6'd0) begin
                if (tok_kind !== `SDMC_TOK_OUT || tok_bytes !== 4'd3) begin
    ...
    initial begin
        $dumpfile("tb_sdmc_aead128_pt3.vcd");
        $dumpvars(0, tb_sdmc_aead128_pt3);
        ...
        if (enc_out !== 152'ha27c2b49a97115ad39df8e6b81128eafdec3e8) begin
            $display("FAIL enc_out mismatch got=%h exp=%h", enc_out, 152'ha27c2b49a97115ad39df8e6b81128eafdec3e8);
            $finish;
        end

        $display("PASS sdmc_aead128_pt3");
        $finish;
    end
