...
module tb_sdmc_aead128_pt5;

    localparam TOKEN_W = `SDMC_TOKEN_W;
    localparam OUT_BYTES = 21;
    ...
    wire [TOKEN_W-1:0] token4 = {1'b1, `SDMC_TOK_MSG,   4'd5, 64'h0000002423222120};
    ...
    always @(posedge clk) begin
        if (!rst_n || clear) begin
            ...
            if (out_idx == 6'd0) begin
                if (tok_kind !== `SDMC_TOK_OUT || tok_bytes !== 4'd5) begin
    ...
    initial begin
        $dumpfile("tb_sdmc_aead128_pt5.vcd");
        $dumpvars(0, tb_sdmc_aead128_pt5);
        ...
        if (enc_out !== 168'ha7942ac846dab7c874f08f8a392a812124eedec3e8) begin
            $display("FAIL enc_out mismatch got=%h exp=%h", enc_out, 168'ha7942ac846dab7c874f08f8a392a812124eedec3e8);
            $finish;
        end

        $display("PASS sdmc_aead128_pt5");
        $finish;
    end
