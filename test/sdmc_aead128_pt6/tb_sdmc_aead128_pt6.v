...
module tb_sdmc_aead128_pt6;

    localparam TOKEN_W = `SDMC_TOKEN_W;
    localparam OUT_BYTES = 22;
    ...
    wire [TOKEN_W-1:0] token4 = {1'b1, `SDMC_TOK_MSG,   4'd6, 64'h0000252423222120};
    ...
    always @(posedge clk) begin
        if (!rst_n || clear) begin
            ...
            if (out_idx == 6'd0) begin
                if (tok_kind !== `SDMC_TOK_OUT || tok_bytes !== 4'd6) begin
    ...
    initial begin
        $dumpfile("tb_sdmc_aead128_pt6.vcd");
        $dumpvars(0, tb_sdmc_aead128_pt6);
        ...
        if (enc_out !== 176'hf2e0aeb40ac157118d92c7af4252d7056c24eedec3e8) begin
            $display("FAIL enc_out mismatch got=%h exp=%h", enc_out, 176'hf2e0aeb40ac157118d92c7af4252d7056c24eedec3e8);
            $finish;
        end

        $display("PASS sdmc_aead128_pt6");
        $finish;
    end
