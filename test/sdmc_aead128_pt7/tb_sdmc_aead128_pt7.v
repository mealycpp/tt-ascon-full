...
module tb_sdmc_aead128_pt7;

    localparam TOKEN_W = `SDMC_TOKEN_W;
    localparam OUT_BYTES = 23;
    ...
    wire [TOKEN_W-1:0] token4 = {1'b1, `SDMC_TOK_MSG,   4'd7, 64'h0026252423222120};
    ...
    always @(posedge clk) begin
        if (!rst_n || clear) begin
            ...
            if (out_idx == 6'd0) begin
                if (tok_kind !== `SDMC_TOK_OUT || tok_bytes !== 4'd7) begin
    ...
    initial begin
        $dumpfile("tb_sdmc_aead128_pt7.vcd");
        $dumpvars(0, tb_sdmc_aead128_pt7);
        ...
        if (enc_out !== 184'h7af8a3777605dadbe96e45d2724f3b65c56c24eedec3e8) begin
            $display("FAIL enc_out mismatch got=%h exp=%h", enc_out, 184'h7af8a3777605dadbe96e45d2724f3b65c56c24eedec3e8);
            $finish;
        end

        $display("PASS sdmc_aead128_pt7");
        $finish;
    end
