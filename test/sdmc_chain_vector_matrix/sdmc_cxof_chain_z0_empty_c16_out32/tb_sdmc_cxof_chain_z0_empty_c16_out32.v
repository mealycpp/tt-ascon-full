...
module tb_sdmc_cxof_chain_z0_empty_c16_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z0_empty_c16_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z0_empty_c16_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z0_empty_c16_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z0_empty_c16_out32");
            $finish;
        end
        ...
        if (got !== 256'h1674b8053878b026e36be0aaf8fbe837dab6fa657acff0a083c6d84929c84e33) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z0_empty_c16_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h1674b8053878b026e36be0aaf8fbe837dab6fa657acff0a083c6d84929c84e33);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z0_empty_c16_out32");
        $finish;
    end
