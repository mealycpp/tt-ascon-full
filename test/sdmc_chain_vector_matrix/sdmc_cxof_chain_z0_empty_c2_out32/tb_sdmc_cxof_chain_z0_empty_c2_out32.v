...
module tb_sdmc_cxof_chain_z0_empty_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z0_empty_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z0_empty_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z0_empty_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z0_empty_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'ha7d0c1ca0349aa01cbba156dbe571027789a3e8e480420bc243090ee5ce3a7d4) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z0_empty_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'ha7d0c1ca0349aa01cbba156dbe571027789a3e8e480420bc243090ee5ce3a7d4);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z0_empty_c2_out32");
        $finish;
    end
