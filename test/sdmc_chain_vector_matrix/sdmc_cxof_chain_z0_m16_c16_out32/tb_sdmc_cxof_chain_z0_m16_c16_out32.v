...
module tb_sdmc_cxof_chain_z0_m16_c16_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z0_m16_c16_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z0_m16_c16_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z0_m16_c16_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z0_m16_c16_out32");
            $finish;
        end
        ...
        if (got !== 256'h280cfac03efba92ac6ab5ee4a30e38e23589c30dfc7c1c4af4abee7f50503144) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z0_m16_c16_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h280cfac03efba92ac6ab5ee4a30e38e23589c30dfc7c1c4af4abee7f50503144);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z0_m16_c16_out32");
        $finish;
    end
