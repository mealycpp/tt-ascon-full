...
module tb_sdmc_cxof_chain_z0_m16_c16_out64;

    localparam integer TOKEN_COUNT = 2;
    ...
    initial begin
        ...
        token_mem[1] = {1'b1, `SDMC_TOK_MSG, 4'd8, 64'h0f0e0d0c0b0a0908};
    end
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z0_m16_c16_out64.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z0_m16_c16_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z0_m16_c16_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z0_m16_c16_out64");
            $finish;
        end
        ...
        if (got !== 512'hfef39487a8c8a34e2d724f0e2cd6f0c1242e4cefb8d0c9c4d98d6b0d155c036a280cfac03efba92ac6ab5ee4a30e38e23589c30dfc7c1c4af4abee7f50503144) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z0_m16_c16_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'hfef39487a8c8a34e2d724f0e2cd6f0c1242e4cefb8d0c9c4d98d6b0d155c036a280cfac03efba92ac6ab5ee4a30e38e23589c30dfc7c1c4af4abee7f50503144);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z0_m16_c16_out64");
        $finish;
    end
