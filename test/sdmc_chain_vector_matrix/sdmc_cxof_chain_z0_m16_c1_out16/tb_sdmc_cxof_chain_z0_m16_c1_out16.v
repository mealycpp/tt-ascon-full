...
module tb_sdmc_cxof_chain_z0_m16_c1_out16;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z0_m16_c1_out16.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z0_m16_c1_out16);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z0_m16_c1_out16");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z0_m16_c1_out16");
            $finish;
        end
        ...
        if (got !== 128'h0162db3440aca01c19b2b88c6b38d85b) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z0_m16_c1_out16");
            $display("got=%h", got);
            $display("exp=%h", 128'h0162db3440aca01c19b2b88c6b38d85b);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z0_m16_c1_out16");
        $finish;
    end
