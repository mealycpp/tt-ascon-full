...
module tb_sdmc_cxof_chain_z0_m16_c1_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z0_m16_c1_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z0_m16_c1_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z0_m16_c1_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z0_m16_c1_out32");
            $finish;
        end
        ...
        if (got !== 256'h94516e195cdc08621ee999a07d7fa9210162db3440aca01c19b2b88c6b38d85b) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z0_m16_c1_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h94516e195cdc08621ee999a07d7fa9210162db3440aca01c19b2b88c6b38d85b);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z0_m16_c1_out32");
        $finish;
    end
