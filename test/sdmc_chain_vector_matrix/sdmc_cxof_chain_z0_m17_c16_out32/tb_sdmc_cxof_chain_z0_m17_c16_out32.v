...
module tb_sdmc_cxof_chain_z0_m17_c16_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z0_m17_c16_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z0_m17_c16_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z0_m17_c16_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z0_m17_c16_out32");
            $finish;
        end
        ...
        if (got !== 256'h6161e811aabb45abdc61782434da908cecbd6db99c5cc6ae497a74b8348091db) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z0_m17_c16_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h6161e811aabb45abdc61782434da908cecbd6db99c5cc6ae497a74b8348091db);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z0_m17_c16_out32");
        $finish;
    end
