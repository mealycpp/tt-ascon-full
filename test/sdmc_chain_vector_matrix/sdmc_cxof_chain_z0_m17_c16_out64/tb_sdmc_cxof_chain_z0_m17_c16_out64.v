...
module tb_sdmc_cxof_chain_z0_m17_c16_out64;

    localparam integer TOKEN_COUNT = 3;
    ...
    initial begin
        ...
        token_mem[2] = {1'b1, `SDMC_TOK_MSG, 4'd1, 64'h0000000000000010};
    end
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z0_m17_c16_out64.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z0_m17_c16_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z0_m17_c16_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z0_m17_c16_out64");
            $finish;
        end
        ...
        if (got !== 512'h5b6cb490095d23fa65e1ab35fed58ae87963591c19c72f5df314867ec54de1686161e811aabb45abdc61782434da908cecbd6db99c5cc6ae497a74b8348091db) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z0_m17_c16_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'h5b6cb490095d23fa65e1ab35fed58ae87963591c19c72f5df314867ec54de1686161e811aabb45abdc61782434da908cecbd6db99c5cc6ae497a74b8348091db);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z0_m17_c16_out64");
        $finish;
    end
