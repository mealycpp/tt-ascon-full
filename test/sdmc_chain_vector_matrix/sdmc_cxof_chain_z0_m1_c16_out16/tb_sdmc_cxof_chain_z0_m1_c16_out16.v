...
module tb_sdmc_cxof_chain_z0_m1_c16_out16;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z0_m1_c16_out16.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z0_m1_c16_out16);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z0_m1_c16_out16");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z0_m1_c16_out16");
            $finish;
        end
        ...
        if (got !== 128'hcffc715039a3351503697a3b9555ac0d) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z0_m1_c16_out16");
            $display("got=%h", got);
            $display("exp=%h", 128'hcffc715039a3351503697a3b9555ac0d);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z0_m1_c16_out16");
        $finish;
    end
