...
module tb_sdmc_cxof_chain_z0_m1_c16_out64;
    ...
    initial begin
        token_mem[0] = {1'b1, `SDMC_TOK_MSG, 4'd1, 64'h0000000000000000};
    end
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z0_m1_c16_out64.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z0_m1_c16_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z0_m1_c16_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z0_m1_c16_out64");
            $finish;
        end
        ...
        if (got !== 512'h72d7175d13ce8547789f2a39968bc3388e6d3144eaad764fb5c3dca1937866ca35f981be10f2b2c93d47180887772229cffc715039a3351503697a3b9555ac0d) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z0_m1_c16_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'h72d7175d13ce8547789f2a39968bc3388e6d3144eaad764fb5c3dca1937866ca35f981be10f2b2c93d47180887772229cffc715039a3351503697a3b9555ac0d);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z0_m1_c16_out64");
        $finish;
    end
