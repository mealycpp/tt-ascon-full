...
module tb_sdmc_cxof_chain_z0_m1_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z0_m1_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z0_m1_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z0_m1_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z0_m1_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'h95431c77c244ff79457936e2b4db18a980b4735a772e3a8d563ec738a8268b26) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z0_m1_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h95431c77c244ff79457936e2b4db18a980b4735a772e3a8d563ec738a8268b26);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z0_m1_c2_out32");
        $finish;
    end
