...
module tb_sdmc_cxof_chain_z0_m32_c16_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z0_m32_c16_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z0_m32_c16_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z0_m32_c16_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z0_m32_c16_out32");
            $finish;
        end
        ...
        if (got !== 256'h0d3a80f31c1b54c304222507fc03273df78004465fa961496b0b22d846f46dda) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z0_m32_c16_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h0d3a80f31c1b54c304222507fc03273df78004465fa961496b0b22d846f46dda);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z0_m32_c16_out32");
        $finish;
    end
