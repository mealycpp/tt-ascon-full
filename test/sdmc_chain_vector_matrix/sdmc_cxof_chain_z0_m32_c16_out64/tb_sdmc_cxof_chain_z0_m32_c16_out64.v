...
module tb_sdmc_cxof_chain_z0_m32_c16_out64;

    localparam integer TOKEN_COUNT = 4;
    ...
    initial begin
        token_mem[0] = {1'b0, `SDMC_TOK_MSG, 4'd8, 64'h0706050403020100};
        token_mem[1] = {1'b0, `SDMC_TOK_MSG, 4'd8, 64'h0f0e0d0c0b0a0908};
        token_mem[2] = {1'b0, `SDMC_TOK_MSG, 4'd8, 64'h1716151413121110};
        token_mem[3] = {1'b1, `SDMC_TOK_MSG, 4'd8, 64'h1f1e1d1c1b1a1918};
    end
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z0_m32_c16_out64.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z0_m32_c16_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z0_m32_c16_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z0_m32_c16_out64");
            $finish;
        end
        ...
        if (got !== 512'h1133716b353373e81e9fcc7382adf944c413003f156f69d39811b3fe06568fea0d3a80f31c1b54c304222507fc03273df78004465fa961496b0b22d846f46dda) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z0_m32_c16_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'h1133716b353373e81e9fcc7382adf944c413003f156f69d39811b3fe06568fea0d3a80f31c1b54c304222507fc03273df78004465fa961496b0b22d846f46dda);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z0_m32_c16_out64");
        $finish;
    end
