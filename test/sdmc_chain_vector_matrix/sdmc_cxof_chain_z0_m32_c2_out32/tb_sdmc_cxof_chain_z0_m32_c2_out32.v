...
module tb_sdmc_cxof_chain_z0_m32_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z0_m32_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z0_m32_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z0_m32_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z0_m32_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'h42ab59a7ada68fe1a8c45e2939c9e888ebd66f47ff59cbf3fdfd54b21905ec2a) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z0_m32_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h42ab59a7ada68fe1a8c45e2939c9e888ebd66f47ff59cbf3fdfd54b21905ec2a);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z0_m32_c2_out32");
        $finish;
    end
