...
module tb_sdmc_cxof_chain_z0_m32_c5_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z0_m32_c5_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z0_m32_c5_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z0_m32_c5_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z0_m32_c5_out32");
            $finish;
        end
        ...
        if (got !== 256'hd0c5645c151c49b3b91e9cdd52bd21dd83123fa72fcc66a9d8d0c36e868794fa) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z0_m32_c5_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'hd0c5645c151c49b3b91e9cdd52bd21dd83123fa72fcc66a9d8d0c36e868794fa);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z0_m32_c5_out32");
        $finish;
    end
