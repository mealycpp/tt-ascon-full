...
module tb_sdmc_cxof_chain_z0_m8_c16_out64;
    ...
    initial begin
        token_mem[0] = {1'b1, `SDMC_TOK_MSG, 4'd8, 64'h0706050403020100};
    end
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z0_m8_c16_out64.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z0_m8_c16_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z0_m8_c16_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z0_m8_c16_out64");
            $finish;
        end
        ...
        if (got !== 512'h4a548ad0f944c5509b478794150c3ab06baca3af8e73e6039a0614132e079caeb727db86b5415142ab2ca980b93e1ea49572b3ade628bfa36703f904fa3b7fde) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z0_m8_c16_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'h4a548ad0f944c5509b478794150c3ab06baca3af8e73e6039a0614132e079caeb727db86b5415142ab2ca980b93e1ea49572b3ade628bfa36703f904fa3b7fde);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z0_m8_c16_out64");
        $finish;
    end
