...
module tb_sdmc_cxof_chain_z0_m8_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z0_m8_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z0_m8_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z0_m8_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z0_m8_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'hfa60e767a5091fab7f71fdeea948752c512679e785e4f66bee6afb367a818396) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z0_m8_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'hfa60e767a5091fab7f71fdeea948752c512679e785e4f66bee6afb367a818396);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z0_m8_c2_out32");
        $finish;
    end
