...
module tb_sdmc_cxof_chain_z16_empty_c16_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z16_empty_c16_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z16_empty_c16_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z16_empty_c16_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z16_empty_c16_out32");
            $finish;
        end
        ...
        if (got !== 256'hc16d67259d4c542313546e731e87260b18bbec1d6b2fbb44896544ed06ec7c79) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z16_empty_c16_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'hc16d67259d4c542313546e731e87260b18bbec1d6b2fbb44896544ed06ec7c79);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z16_empty_c16_out32");
        $finish;
    end
