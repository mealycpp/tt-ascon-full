...
module tb_sdmc_cxof_chain_z16_empty_c1_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z16_empty_c1_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z16_empty_c1_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z16_empty_c1_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z16_empty_c1_out32");
            $finish;
        end
        ...
        if (got !== 256'hd13f44990fc9a63408969c44c225a493debb6a3630b1546511c2cceb9a83e072) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z16_empty_c1_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'hd13f44990fc9a63408969c44c225a493debb6a3630b1546511c2cceb9a83e072);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z16_empty_c1_out32");
        $finish;
    end
