...
module tb_sdmc_cxof_chain_z16_empty_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z16_empty_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z16_empty_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z16_empty_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z16_empty_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'h5bc6fee207f482c20b235dc12384ebc950f58484b10d9f19b6051a8173ccc13e) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z16_empty_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h5bc6fee207f482c20b235dc12384ebc950f58484b10d9f19b6051a8173ccc13e);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z16_empty_c2_out32");
        $finish;
    end
