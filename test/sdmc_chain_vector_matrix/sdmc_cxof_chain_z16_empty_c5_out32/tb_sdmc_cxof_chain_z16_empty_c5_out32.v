...
module tb_sdmc_cxof_chain_z16_empty_c5_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z16_empty_c5_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z16_empty_c5_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z16_empty_c5_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z16_empty_c5_out32");
            $finish;
        end
        ...
        if (got !== 256'h2eb74edcc1aa3dc93517467748eed280de5cf77664773d30eb776cac2a90c9c2) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z16_empty_c5_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h2eb74edcc1aa3dc93517467748eed280de5cf77664773d30eb776cac2a90c9c2);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z16_empty_c5_out32");
        $finish;
    end
