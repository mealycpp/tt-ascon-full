...
module tb_sdmc_cxof_chain_z16_m16_c16_out16;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z16_m16_c16_out16.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z16_m16_c16_out16);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z16_m16_c16_out16");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z16_m16_c16_out16");
            $finish;
        end
        ...
        if (got !== 128'h896e76e6c5493709dd2399283e1bcd07) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z16_m16_c16_out16");
            $display("got=%h", got);
            $display("exp=%h", 128'h896e76e6c5493709dd2399283e1bcd07);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z16_m16_c16_out16");
        $finish;
    end
