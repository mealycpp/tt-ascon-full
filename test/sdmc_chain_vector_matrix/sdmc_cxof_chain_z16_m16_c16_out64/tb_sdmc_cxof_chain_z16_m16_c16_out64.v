...
module tb_sdmc_cxof_chain_z16_m16_c16_out64;
    ...
    initial begin
        ...
        token_mem[3] = {1'b1, `SDMC_TOK_MSG, 4'd8, 64'h0f0e0d0c0b0a0908};
    end
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z16_m16_c16_out64.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z16_m16_c16_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z16_m16_c16_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z16_m16_c16_out64");
            $finish;
        end
        ...
        if (got !== 512'he197904985a5c37bb28be51c351f05984c60bb47891898aa31bf00fd506c2d32c65c4c7eed77fc185949fce560dd0955896e76e6c5493709dd2399283e1bcd07) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z16_m16_c16_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'he197904985a5c37bb28be51c351f05984c60bb47891898aa31bf00fd506c2d32c65c4c7eed77fc185949fce560dd0955896e76e6c5493709dd2399283e1bcd07);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z16_m16_c16_out64");
        $finish;
    end
