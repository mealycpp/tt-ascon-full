...
module tb_sdmc_cxof_chain_z16_m16_c1_out16;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z16_m16_c1_out16.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z16_m16_c1_out16);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z16_m16_c1_out16");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z16_m16_c1_out16");
            $finish;
        end
        ...
        if (got !== 128'hab83be9073861178ed852ed152681f16) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z16_m16_c1_out16");
            $display("got=%h", got);
            $display("exp=%h", 128'hab83be9073861178ed852ed152681f16);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z16_m16_c1_out16");
        $finish;
    end
