...
module tb_sdmc_cxof_chain_z16_m16_c1_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z16_m16_c1_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z16_m16_c1_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z16_m16_c1_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z16_m16_c1_out32");
            $finish;
        end
        ...
        if (got !== 256'h6516490d601de5a396ac6e4556952cb5ab83be9073861178ed852ed152681f16) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z16_m16_c1_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h6516490d601de5a396ac6e4556952cb5ab83be9073861178ed852ed152681f16);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z16_m16_c1_out32");
        $finish;
    end
