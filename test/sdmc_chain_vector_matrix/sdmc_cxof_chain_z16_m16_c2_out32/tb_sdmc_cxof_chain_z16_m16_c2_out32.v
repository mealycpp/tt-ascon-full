...
module tb_sdmc_cxof_chain_z16_m16_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z16_m16_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z16_m16_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z16_m16_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z16_m16_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'h760541ba026bd81a38f3fe9105795582b835ad48d3ac80ee5d043cab4a418177) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z16_m16_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h760541ba026bd81a38f3fe9105795582b835ad48d3ac80ee5d043cab4a418177);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z16_m16_c2_out32");
        $finish;
    end
