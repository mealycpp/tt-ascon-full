...
module tb_sdmc_cxof_chain_z16_m1_c16_out64;
    ...
    initial begin
        ...
        token_mem[2] = {1'b1, `SDMC_TOK_MSG, 4'd1, 64'h0000000000000000};
    end
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z16_m1_c16_out64.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z16_m1_c16_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z16_m1_c16_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z16_m1_c16_out64");
            $finish;
        end
        ...
        if (got !== 512'h916143180b762814e4355f0112d07ade1dbb2522806bbaba9e96b0c198dd8c7d6d7f4f6a3893683467a130fdad508327949b4a78afbbc617beebbcfb10d6cb3f) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z16_m1_c16_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'h916143180b762814e4355f0112d07ade1dbb2522806bbaba9e96b0c198dd8c7d6d7f4f6a3893683467a130fdad508327949b4a78afbbc617beebbcfb10d6cb3f);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z16_m1_c16_out64");
        $finish;
    end
