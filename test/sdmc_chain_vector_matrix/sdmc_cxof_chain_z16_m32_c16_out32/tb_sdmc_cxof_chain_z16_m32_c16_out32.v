...
module tb_sdmc_cxof_chain_z16_m32_c16_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z16_m32_c16_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z16_m32_c16_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z16_m32_c16_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z16_m32_c16_out32");
            $finish;
        end
        ...
        if (got !== 256'hcfabb012e5359896f81d8d2416544632580aa065f66dac829bbe29cbdd36e437) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z16_m32_c16_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'hcfabb012e5359896f81d8d2416544632580aa065f66dac829bbe29cbdd36e437);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z16_m32_c16_out32");
        $finish;
    end
