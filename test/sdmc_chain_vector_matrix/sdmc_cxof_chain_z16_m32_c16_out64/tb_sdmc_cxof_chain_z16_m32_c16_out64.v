...
module tb_sdmc_cxof_chain_z16_m32_c16_out64;
    ...
    initial begin
        ...
        token_mem[4] = {1'b0, `SDMC_TOK_MSG, 4'd8, 64'h1716151413121110};
        token_mem[5] = {1'b1, `SDMC_TOK_MSG, 4'd8, 64'h1f1e1d1c1b1a1918};
    end
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z16_m32_c16_out64.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z16_m32_c16_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z16_m32_c16_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z16_m32_c16_out64");
            $finish;
        end
        ...
        if (got !== 512'h975855f93e3ac35c8edff60185a286c17e28d67d4c21a16473579d65c07b05c9cfabb012e5359896f81d8d2416544632580aa065f66dac829bbe29cbdd36e437) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z16_m32_c16_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'h975855f93e3ac35c8edff60185a286c17e28d67d4c21a16473579d65c07b05c9cfabb012e5359896f81d8d2416544632580aa065f66dac829bbe29cbdd36e437);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z16_m32_c16_out64");
        $finish;
    end
