...
module tb_sdmc_cxof_chain_z16_m32_c1_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z16_m32_c1_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z16_m32_c1_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z16_m32_c1_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z16_m32_c1_out32");
            $finish;
        end
        ...
        if (got !== 256'had781c671979dc45c5d0ce4cba21b7fd705b4add8388a3a77f4ca5ec5b4bdbb0) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z16_m32_c1_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'had781c671979dc45c5d0ce4cba21b7fd705b4add8388a3a77f4ca5ec5b4bdbb0);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z16_m32_c1_out32");
        $finish;
    end
