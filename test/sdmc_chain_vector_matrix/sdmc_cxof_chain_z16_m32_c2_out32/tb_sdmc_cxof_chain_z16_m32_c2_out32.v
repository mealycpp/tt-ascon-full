...
module tb_sdmc_cxof_chain_z16_m32_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z16_m32_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z16_m32_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z16_m32_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z16_m32_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'h4cc6b7d058d1929da792151c5ef17c2c64002bb98b02697dea46ba56ac9938e0) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z16_m32_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h4cc6b7d058d1929da792151c5ef17c2c64002bb98b02697dea46ba56ac9938e0);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z16_m32_c2_out32");
        $finish;
    end
