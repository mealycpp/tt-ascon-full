...
module tb_sdmc_cxof_chain_z16_m8_c16_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z16_m8_c16_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z16_m8_c16_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z16_m8_c16_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z16_m8_c16_out32");
            $finish;
        end
        ...
        if (got !== 256'hc266184b9602f2764f7d7416a6f367dff03b5a7b52fc697f6ddb20011a750b22) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z16_m8_c16_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'hc266184b9602f2764f7d7416a6f367dff03b5a7b52fc697f6ddb20011a750b22);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z16_m8_c16_out32");
        $finish;
    end
