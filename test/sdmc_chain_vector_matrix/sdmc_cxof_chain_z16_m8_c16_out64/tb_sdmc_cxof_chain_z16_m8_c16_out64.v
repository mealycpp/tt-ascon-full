...
module tb_sdmc_cxof_chain_z16_m8_c16_out64;
    ...
    initial begin
        ...
        token_mem[2] = {1'b1, `SDMC_TOK_MSG, 4'd8, 64'h0706050403020100};
    end
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z16_m8_c16_out64.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z16_m8_c16_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z16_m8_c16_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z16_m8_c16_out64");
            $finish;
        end
        ...
        if (got !== 512'h1503c6612c70068abca31bf19fa4d4c1bc7799482010b0d3d90112d2d65fc7f5c266184b9602f2764f7d7416a6f367dff03b5a7b52fc697f6ddb20011a750b22) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z16_m8_c16_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'h1503c6612c70068abca31bf19fa4d4c1bc7799482010b0d3d90112d2d65fc7f5c266184b9602f2764f7d7416a6f367dff03b5a7b52fc697f6ddb20011a750b22);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z16_m8_c16_out64");
        $finish;
    end
