...
module tb_sdmc_cxof_chain_z16_m8_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z16_m8_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z16_m8_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z16_m8_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z16_m8_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'h46297134ff2dafff2a65dfe01a70504fbfd5da7f5652ca51c98f336597a68d50) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z16_m8_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h46297134ff2dafff2a65dfe01a70504fbfd5da7f5652ca51c98f336597a68d50);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z16_m8_c2_out32");
        $finish;
    end
