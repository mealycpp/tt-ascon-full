...
module tb_sdmc_cxof_chain_z16_m8_c5_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z16_m8_c5_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z16_m8_c5_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z16_m8_c5_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z16_m8_c5_out32");
            $finish;
        end
        ...
        if (got !== 256'hf8c36c3f5a612b6bf7f58bb727e001dcda024d638deab6112ddbd74f97c2c0c5) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z16_m8_c5_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'hf8c36c3f5a612b6bf7f58bb727e001dcda024d638deab6112ddbd74f97c2c0c5);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z16_m8_c5_out32");
        $finish;
    end
