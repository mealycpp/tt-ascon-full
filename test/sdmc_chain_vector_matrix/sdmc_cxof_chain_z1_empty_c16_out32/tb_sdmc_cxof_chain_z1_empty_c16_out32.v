...
module tb_sdmc_cxof_chain_z1_empty_c16_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z1_empty_c16_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z1_empty_c16_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z1_empty_c16_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z1_empty_c16_out32");
            $finish;
        end
        ...
        if (got !== 256'h3bd12b2e6babbbd8a290390766d439fa98183caa9d073d46c0e37367d5183e35) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z1_empty_c16_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h3bd12b2e6babbbd8a290390766d439fa98183caa9d073d46c0e37367d5183e35);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z1_empty_c16_out32");
        $finish;
    end
