...
module tb_sdmc_cxof_chain_z1_empty_c16_out64;

    localparam integer TOKEN_COUNT = 1;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z1_empty_c16_out64.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z1_empty_c16_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z1_empty_c16_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z1_empty_c16_out64");
            $finish;
        end
        ...
        if (got !== 512'heb8152ec9375b96365225701089efb9af855fa9d0e336cf4316ccb7866943e083bd12b2e6babbbd8a290390766d439fa98183caa9d073d46c0e37367d5183e35) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z1_empty_c16_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'heb8152ec9375b96365225701089efb9af855fa9d0e336cf4316ccb7866943e083bd12b2e6babbbd8a290390766d439fa98183caa9d073d46c0e37367d5183e35);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z1_empty_c16_out64");
        $finish;
    end
