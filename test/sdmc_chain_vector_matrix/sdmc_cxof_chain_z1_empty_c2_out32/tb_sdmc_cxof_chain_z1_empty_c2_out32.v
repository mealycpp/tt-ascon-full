...
module tb_sdmc_cxof_chain_z1_empty_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z1_empty_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z1_empty_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z1_empty_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z1_empty_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'hed425bf9daf7fb01f1ab636f0f01303514132b1a1b38bb80970d1de184f37c7f) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z1_empty_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'hed425bf9daf7fb01f1ab636f0f01303514132b1a1b38bb80970d1de184f37c7f);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z1_empty_c2_out32");
        $finish;
    end
