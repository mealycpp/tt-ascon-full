...
module tb_sdmc_cxof_chain_z1_empty_c5_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z1_empty_c5_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z1_empty_c5_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z1_empty_c5_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z1_empty_c5_out32");
            $finish;
        end
        ...
        if (got !== 256'hab11217749ab921b60885111d6240edee7b1fcd4d0b7a22f78f51a58ff1baf55) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z1_empty_c5_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'hab11217749ab921b60885111d6240edee7b1fcd4d0b7a22f78f51a58ff1baf55);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z1_empty_c5_out32");
        $finish;
    end
