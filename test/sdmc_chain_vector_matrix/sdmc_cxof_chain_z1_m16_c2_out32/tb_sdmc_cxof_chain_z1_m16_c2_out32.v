...
module tb_sdmc_cxof_chain_z1_m16_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z1_m16_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z1_m16_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z1_m16_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z1_m16_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'hd3798dd8d9c32ed2bae73139184f123c8eddfaf677849c5acfb2de7b08d2ee48) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z1_m16_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'hd3798dd8d9c32ed2bae73139184f123c8eddfaf677849c5acfb2de7b08d2ee48);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z1_m16_c2_out32");
        $finish;
    end
