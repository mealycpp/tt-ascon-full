...
module tb_sdmc_cxof_chain_z1_m17_c1_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z1_m17_c1_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z1_m17_c1_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z1_m17_c1_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z1_m17_c1_out32");
            $finish;
        end
        ...
        if (got !== 256'h0f7faecaea44b7a0ccf6da1a254dfcd450c68ce26350ef862058e324f6099f30) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z1_m17_c1_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h0f7faecaea44b7a0ccf6da1a254dfcd450c68ce26350ef862058e324f6099f30);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z1_m17_c1_out32");
        $finish;
    end
