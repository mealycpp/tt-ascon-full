...
module tb_sdmc_cxof_chain_z1_m17_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z1_m17_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z1_m17_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z1_m17_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z1_m17_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'h5eb06be6ef3a8edb02f9e01069ca928a3cd26d0b241d20f6c22f8a57d7d2889c) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z1_m17_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h5eb06be6ef3a8edb02f9e01069ca928a3cd26d0b241d20f6c22f8a57d7d2889c);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z1_m17_c2_out32");
        $finish;
    end
