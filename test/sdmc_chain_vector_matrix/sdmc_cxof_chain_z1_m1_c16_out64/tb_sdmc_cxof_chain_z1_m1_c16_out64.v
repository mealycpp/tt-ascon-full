...
module tb_sdmc_cxof_chain_z1_m1_c16_out64;
    ...
    initial begin
        ...
        token_mem[1] = {1'b1, `SDMC_TOK_MSG, 4'd1, 64'h0000000000000000};
    end
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z1_m1_c16_out64.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z1_m1_c16_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z1_m1_c16_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z1_m1_c16_out64");
            $finish;
        end
        ...
        if (got !== 512'h6e50b2f112d41c615cec655e1eebb1577430d9b7b1b2156ec03cf21e5140e8bfdb4c581ab9923edf8f68d999452bb70c49975496de5120e252368a91fe4ede59) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z1_m1_c16_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'h6e50b2f112d41c615cec655e1eebb1577430d9b7b1b2156ec03cf21e5140e8bfdb4c581ab9923edf8f68d999452bb70c49975496de5120e252368a91fe4ede59);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z1_m1_c16_out64");
        $finish;
    end
