...
module tb_sdmc_cxof_chain_z1_m32_c16_out64;
    ...
    initial begin
        token_mem[0] = {1'b1, `SDMC_TOK_CS, 4'd1, 64'h0000000000000010};
        token_mem[1] = {1'b0, `SDMC_TOK_MSG, 4'd8, 64'h0706050403020100};
        token_mem[2] = {1'b0, `SDMC_TOK_MSG, 4'd8, 64'h0f0e0d0c0b0a0908};
        token_mem[3] = {1'b0, `SDMC_TOK_MSG, 4'd8, 64'h1716151413121110};
        token_mem[4] = {1'b1, `SDMC_TOK_MSG, 4'd8, 64'h1f1e1d1c1b1a1918};
    end
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z1_m32_c16_out64.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z1_m32_c16_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z1_m32_c16_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z1_m32_c16_out64");
            $finish;
        end
        ...
        if (got !== 512'hd949d21f1e7fb473cc2829888427d22b874abc2255579289a7d97fc3473ed021e2f9dfbc2998f9b7a7c2f3d1eae11300bcdf576f8e183b9cd666a9c2fdca9096) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z1_m32_c16_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'hd949d21f1e7fb473cc2829888427d22b874abc2255579289a7d97fc3473ed021e2f9dfbc2998f9b7a7c2f3d1eae11300bcdf576f8e183b9cd666a9c2fdca9096);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z1_m32_c16_out64");
        $finish;
    end
