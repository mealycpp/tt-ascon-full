...
module tb_sdmc_cxof_chain_z1_m32_c5_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z1_m32_c5_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z1_m32_c5_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z1_m32_c5_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z1_m32_c5_out32");
            $finish;
        end
        ...
        if (got !== 256'hbd3af020cff9e21cdb5771d2aaca307ddc5bf1ce6d7bace1f46f878342113178) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z1_m32_c5_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'hbd3af020cff9e21cdb5771d2aaca307ddc5bf1ce6d7bace1f46f878342113178);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z1_m32_c5_out32");
        $finish;
    end
