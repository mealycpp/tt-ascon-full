...
module tb_sdmc_cxof_chain_z1_m8_c1_out16;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z1_m8_c1_out16.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z1_m8_c1_out16);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z1_m8_c1_out16");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z1_m8_c1_out16");
            $finish;
        end
        ...
        if (got !== 128'h93363a2a5f1c0fbb502146bd46f5c172) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z1_m8_c1_out16");
            $display("got=%h", got);
            $display("exp=%h", 128'h93363a2a5f1c0fbb502146bd46f5c172);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z1_m8_c1_out16");
        $finish;
    end
