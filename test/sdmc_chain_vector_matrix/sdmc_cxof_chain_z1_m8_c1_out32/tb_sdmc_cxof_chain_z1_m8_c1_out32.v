...
module tb_sdmc_cxof_chain_z1_m8_c1_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z1_m8_c1_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z1_m8_c1_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z1_m8_c1_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z1_m8_c1_out32");
            $finish;
        end
        ...
        if (got !== 256'h2aa77825c1ba2dbbe511a4799a9062fd93363a2a5f1c0fbb502146bd46f5c172) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z1_m8_c1_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h2aa77825c1ba2dbbe511a4799a9062fd93363a2a5f1c0fbb502146bd46f5c172);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z1_m8_c1_out32");
        $finish;
    end
