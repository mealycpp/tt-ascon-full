...
module tb_sdmc_cxof_chain_z1_m8_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z1_m8_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z1_m8_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z1_m8_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z1_m8_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'h62dba32dafe63bc305b66f7de153577d2734b88e7221e83ba24f01d0f9c57d18) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z1_m8_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h62dba32dafe63bc305b66f7de153577d2734b88e7221e83ba24f01d0f9c57d18);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z1_m8_c2_out32");
        $finish;
    end
