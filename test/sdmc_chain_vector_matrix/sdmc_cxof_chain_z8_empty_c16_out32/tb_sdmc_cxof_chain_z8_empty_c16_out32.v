...
module tb_sdmc_cxof_chain_z8_empty_c16_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z8_empty_c16_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z8_empty_c16_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z8_empty_c16_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z8_empty_c16_out32");
            $finish;
        end
        ...
        if (got !== 256'h1d817984678e4699f5d7a37e78e1634f86af0e1b51d2b82cadbe2e093b9661b2) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z8_empty_c16_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h1d817984678e4699f5d7a37e78e1634f86af0e1b51d2b82cadbe2e093b9661b2);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z8_empty_c16_out32");
        $finish;
    end
