...
module tb_sdmc_cxof_chain_z8_empty_c1_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z8_empty_c1_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z8_empty_c1_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z8_empty_c1_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z8_empty_c1_out32");
            $finish;
        end
        ...
        if (got !== 256'hd2afee55e8a6757753cee26fd75e88205818d2d1ba36171ec1d61d4466473261) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z8_empty_c1_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'hd2afee55e8a6757753cee26fd75e88205818d2d1ba36171ec1d61d4466473261);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z8_empty_c1_out32");
        $finish;
    end
