...
module tb_sdmc_cxof_chain_z8_empty_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z8_empty_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z8_empty_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z8_empty_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z8_empty_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'h2a948123d117f6cd7d3f16409ff17d6b5364abbb5ae749adc9d7db78f4263fbe) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z8_empty_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h2a948123d117f6cd7d3f16409ff17d6b5364abbb5ae749adc9d7db78f4263fbe);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z8_empty_c2_out32");
        $finish;
    end
