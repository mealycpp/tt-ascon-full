...
module tb_sdmc_cxof_chain_z8_m16_c16_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z8_m16_c16_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z8_m16_c16_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z8_m16_c16_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z8_m16_c16_out32");
            $finish;
        end
        ...
        if (got !== 256'hcf24a6d8b2fbfc496189f0a6a67579298e48caaa6df7972d1b5674d8d1de5383) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z8_m16_c16_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'hcf24a6d8b2fbfc496189f0a6a67579298e48caaa6df7972d1b5674d8d1de5383);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z8_m16_c16_out32");
        $finish;
    end
