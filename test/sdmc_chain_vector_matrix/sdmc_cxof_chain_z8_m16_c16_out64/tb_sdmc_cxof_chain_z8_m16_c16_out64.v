...
module tb_sdmc_cxof_chain_z8_m16_c16_out64;
    ...
    initial begin
        ...
        token_mem[2] = {1'b1, `SDMC_TOK_MSG, 4'd8, 64'h0f0e0d0c0b0a0908};
    end
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z8_m16_c16_out64.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z8_m16_c16_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z8_m16_c16_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z8_m16_c16_out64");
            $finish;
        end
        ...
        if (got !== 512'hf233bd132646e457891929b68fa81cbdb2324ed393c16136ff8f130958eb7bcacf24a6d8b2fbfc496189f0a6a67579298e48caaa6df7972d1b5674d8d1de5383) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z8_m16_c16_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'hf233bd132646e457891929b68fa81cbdb2324ed393c16136ff8f130958eb7bcacf24a6d8b2fbfc496189f0a6a67579298e48caaa6df7972d1b5674d8d1de5383);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z8_m16_c16_out64");
        $finish;
    end
