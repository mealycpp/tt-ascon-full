...
module tb_sdmc_cxof_chain_z8_m16_c1_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z8_m16_c1_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z8_m16_c1_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z8_m16_c1_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z8_m16_c1_out32");
            $finish;
        end
        ...
        if (got !== 256'hb1a051411e58d843b13306d4ed1bffe38662462fb2e5521c067fd29f4a8f6272) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z8_m16_c1_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'hb1a051411e58d843b13306d4ed1bffe38662462fb2e5521c067fd29f4a8f6272);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z8_m16_c1_out32");
        $finish;
    end
