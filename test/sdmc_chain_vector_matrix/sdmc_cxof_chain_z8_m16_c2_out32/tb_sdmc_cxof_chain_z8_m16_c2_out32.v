...
module tb_sdmc_cxof_chain_z8_m16_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z8_m16_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z8_m16_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z8_m16_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z8_m16_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'h4195daa3ece3ba9e48232786002ad74e675f96dcbc664340f4518e702abb8842) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z8_m16_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h4195daa3ece3ba9e48232786002ad74e675f96dcbc664340f4518e702abb8842);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z8_m16_c2_out32");
        $finish;
    end
