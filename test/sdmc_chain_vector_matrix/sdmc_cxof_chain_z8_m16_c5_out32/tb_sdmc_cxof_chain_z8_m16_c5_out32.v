...
module tb_sdmc_cxof_chain_z8_m16_c5_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z8_m16_c5_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z8_m16_c5_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z8_m16_c5_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z8_m16_c5_out32");
            $finish;
        end
        ...
        if (got !== 256'h129f58feb73c74b2393516af2d3eeb6659cc57fd40a5089c8a12afe77110afd9) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z8_m16_c5_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h129f58feb73c74b2393516af2d3eeb6659cc57fd40a5089c8a12afe77110afd9);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z8_m16_c5_out32");
        $finish;
    end
