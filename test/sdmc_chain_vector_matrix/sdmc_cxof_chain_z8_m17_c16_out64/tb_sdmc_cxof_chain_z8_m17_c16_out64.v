...
module tb_sdmc_cxof_chain_z8_m17_c16_out64;
    ...
    initial begin
        ...
        token_mem[3] = {1'b1, `SDMC_TOK_MSG, 4'd1, 64'h0000000000000010};
    end
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z8_m17_c16_out64.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z8_m17_c16_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z8_m17_c16_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z8_m17_c16_out64");
            $finish;
        end
        ...
        if (got !== 512'h3609c0cf92b9ed726a6a6fcc3b4ff0d553bfe725298df8e4a18f0b501b7618061188e396c6ba0122e49b3153d5bec2c214c7e6491fcae0c0d3abf15853772c2e) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z8_m17_c16_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'h3609c0cf92b9ed726a6a6fcc3b4ff0d553bfe725298df8e4a18f0b501b7618061188e396c6ba0122e49b3153d5bec2c214c7e6491fcae0c0d3abf15853772c2e);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z8_m17_c16_out64");
        $finish;
    end
