...
module tb_sdmc_cxof_chain_z8_m17_c1_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z8_m17_c1_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z8_m17_c1_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z8_m17_c1_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z8_m17_c1_out32");
            $finish;
        end
        ...
        if (got !== 256'hf4fb765f97b17b3cd133cec25bd0e97a1de7f8c1cbce3870eed5dc093934627b) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z8_m17_c1_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'hf4fb765f97b17b3cd133cec25bd0e97a1de7f8c1cbce3870eed5dc093934627b);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z8_m17_c1_out32");
        $finish;
    end
