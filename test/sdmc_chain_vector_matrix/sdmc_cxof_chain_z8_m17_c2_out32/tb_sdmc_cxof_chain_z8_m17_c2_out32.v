...
module tb_sdmc_cxof_chain_z8_m17_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z8_m17_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z8_m17_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z8_m17_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z8_m17_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'h721373acadfc2090d881502e0053f55859ea7e4548d71312f6ad541b3c2f5176) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z8_m17_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h721373acadfc2090d881502e0053f55859ea7e4548d71312f6ad541b3c2f5176);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z8_m17_c2_out32");
        $finish;
    end
