...
module tb_sdmc_cxof_chain_z8_m17_c5_out16;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z8_m17_c5_out16.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z8_m17_c5_out16);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z8_m17_c5_out16");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z8_m17_c5_out16");
            $finish;
        end
        ...
        if (got !== 128'h2a6fb977c1f2f7c7d82019272779c645) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z8_m17_c5_out16");
            $display("got=%h", got);
            $display("exp=%h", 128'h2a6fb977c1f2f7c7d82019272779c645);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z8_m17_c5_out16");
        $finish;
    end
