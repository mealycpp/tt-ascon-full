...
module tb_sdmc_cxof_chain_z8_m17_c5_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z8_m17_c5_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z8_m17_c5_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z8_m17_c5_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z8_m17_c5_out32");
            $finish;
        end
        ...
        if (got !== 256'h7804dd096974f282b371e5b9cea63bda2a6fb977c1f2f7c7d82019272779c645) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z8_m17_c5_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h7804dd096974f282b371e5b9cea63bda2a6fb977c1f2f7c7d82019272779c645);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z8_m17_c5_out32");
        $finish;
    end
