...
module tb_sdmc_cxof_chain_z8_m1_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z8_m1_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z8_m1_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z8_m1_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z8_m1_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'hb95662afd47837686183b3665f1d0536f082e8df556e211d377deef7ddd42d31) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z8_m1_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'hb95662afd47837686183b3665f1d0536f082e8df556e211d377deef7ddd42d31);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z8_m1_c2_out32");
        $finish;
    end
