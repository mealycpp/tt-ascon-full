...
module tb_sdmc_cxof_chain_z8_m32_c16_out64;
    ...
    initial begin
        token_mem[0] = {1'b1, `SDMC_TOK_CS, 4'd8, 64'h1716151413121110};
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z8_m32_c16_out64.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z8_m32_c16_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z8_m32_c16_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z8_m32_c16_out64");
            $finish;
        end
        ...
        if (got !== 512'hdd49b84556141dd76f180178c09e950b5e2848e27d6670ef9dd40d68ce129d16f5b779c4dff16a8882369dc7827aec06761117c1fb07d899258f24ec741fac2d) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z8_m32_c16_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'hdd49b84556141dd76f180178c09e950b5e2848e27d6670ef9dd40d68ce129d16f5b779c4dff16a8882369dc7827aec06761117c1fb07d899258f24ec741fac2d);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z8_m32_c16_out64");
        $finish;
    end
