...
module tb_sdmc_cxof_chain_z8_m8_c16_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z8_m8_c16_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z8_m8_c16_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z8_m8_c16_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z8_m8_c16_out32");
            $finish;
        end
        ...
        if (got !== 256'h4085da36ee7ae01c5b6d0b1df29ddf3ae5812c64702c8ee0400df49993c75576) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z8_m8_c16_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h4085da36ee7ae01c5b6d0b1df29ddf3ae5812c64702c8ee0400df49993c75576);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z8_m8_c16_out32");
        $finish;
    end
