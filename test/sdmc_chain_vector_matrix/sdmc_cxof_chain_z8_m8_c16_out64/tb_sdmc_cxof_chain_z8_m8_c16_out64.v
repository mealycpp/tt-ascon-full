...
module tb_sdmc_cxof_chain_z8_m8_c16_out64;
    ...
    initial begin
        ...
        token_mem[1] = {1'b1, `SDMC_TOK_MSG, 4'd8, 64'h0706050403020100};
    end
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z8_m8_c16_out64.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z8_m8_c16_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z8_m8_c16_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z8_m8_c16_out64");
            $finish;
        end
        ...
        if (got !== 512'h0f3fc43d5c57c221e6dec3fa903e4cbf99afc87e44675f124ffce99404f076124085da36ee7ae01c5b6d0b1df29ddf3ae5812c64702c8ee0400df49993c75576) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z8_m8_c16_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'h0f3fc43d5c57c221e6dec3fa903e4cbf99afc87e44675f124ffce99404f076124085da36ee7ae01c5b6d0b1df29ddf3ae5812c64702c8ee0400df49993c75576);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z8_m8_c16_out64");
        $finish;
    end
