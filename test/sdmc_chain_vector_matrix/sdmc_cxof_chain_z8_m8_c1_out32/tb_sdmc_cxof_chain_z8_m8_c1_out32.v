...
module tb_sdmc_cxof_chain_z8_m8_c1_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z8_m8_c1_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z8_m8_c1_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z8_m8_c1_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z8_m8_c1_out32");
            $finish;
        end
        ...
        if (got !== 256'hecb1741cf82b43f17a5805cb34e0bd3d996fe34707e5024951acc94c90c52f7c) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z8_m8_c1_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'hecb1741cf82b43f17a5805cb34e0bd3d996fe34707e5024951acc94c90c52f7c);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z8_m8_c1_out32");
        $finish;
    end
