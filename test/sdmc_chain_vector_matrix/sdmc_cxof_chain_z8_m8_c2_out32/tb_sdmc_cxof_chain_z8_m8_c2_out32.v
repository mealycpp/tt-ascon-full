...
module tb_sdmc_cxof_chain_z8_m8_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_z8_m8_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_z8_m8_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_cxof_chain_z8_m8_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_cxof_chain_z8_m8_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'hac2736c170a6a6266bf5ac00030f796e2b940bba7c0ba8d3b55a5fe1b33f804d) begin
            $display("FAIL digest mismatch sdmc_cxof_chain_z8_m8_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'hac2736c170a6a6266bf5ac00030f796e2b940bba7c0ba8d3b55a5fe1b33f804d);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_z8_m8_c2_out32");
        $finish;
    end
