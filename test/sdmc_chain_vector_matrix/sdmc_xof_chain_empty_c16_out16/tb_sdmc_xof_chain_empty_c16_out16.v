...
module tb_sdmc_xof_chain_empty_c16_out16;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_empty_c16_out16.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_empty_c16_out16);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_empty_c16_out16");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_empty_c16_out16");
            $finish;
        end
        ...
        if (got !== 128'he496a5bf134357084d3c3ea527e5b084) begin
            $display("FAIL digest mismatch sdmc_xof_chain_empty_c16_out16");
            $display("got=%h", got);
            $display("exp=%h", 128'he496a5bf134357084d3c3ea527e5b084);
            $finish;
        end

        $display("PASS sdmc_xof_chain_empty_c16_out16");
        $finish;
    end
