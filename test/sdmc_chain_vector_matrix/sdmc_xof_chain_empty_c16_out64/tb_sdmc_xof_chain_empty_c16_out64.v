...
module tb_sdmc_xof_chain_empty_c16_out64;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_empty_c16_out64.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_empty_c16_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_empty_c16_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_empty_c16_out64");
            $finish;
        end
        ...
        if (got !== 512'hb8fde336679cc2197623ab6645d7f110b189e91e0a9e4855e50c078ba401236ffcad6035dc521b536cec2f8670acbf1fe496a5bf134357084d3c3ea527e5b084) begin
            $display("FAIL digest mismatch sdmc_xof_chain_empty_c16_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'hb8fde336679cc2197623ab6645d7f110b189e91e0a9e4855e50c078ba401236ffcad6035dc521b536cec2f8670acbf1fe496a5bf134357084d3c3ea527e5b084);
            $finish;
        end

        $display("PASS sdmc_xof_chain_empty_c16_out64");
        $finish;
    end
