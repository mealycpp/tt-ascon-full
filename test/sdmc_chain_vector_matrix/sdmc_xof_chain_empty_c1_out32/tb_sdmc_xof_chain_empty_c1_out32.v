...
module tb_sdmc_xof_chain_empty_c1_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_empty_c1_out32.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_empty_c1_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_empty_c1_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_empty_c1_out32");
            $finish;
        end
        ...
        if (got !== 256'hc6953299b3d960d9e08e3833ed1fd9c22ee48adbac4ad8df398bf564615e3d47) begin
            $display("FAIL digest mismatch sdmc_xof_chain_empty_c1_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'hc6953299b3d960d9e08e3833ed1fd9c22ee48adbac4ad8df398bf564615e3d47);
            $finish;
        end

        $display("PASS sdmc_xof_chain_empty_c1_out32");
        $finish;
    end
