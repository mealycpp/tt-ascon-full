...
module tb_sdmc_xof_chain_empty_c1_out64;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_empty_c1_out64.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_empty_c1_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_empty_c1_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_empty_c1_out64");
            $finish;
        end
        ...
        if (got !== 512'hff10ada3d1672c5d66f1a8056d95d0f73a37888909e6d96afe133b5d5a8577adc6953299b3d960d9e08e3833ed1fd9c22ee48adbac4ad8df398bf564615e3d47) begin
            $display("FAIL digest mismatch sdmc_xof_chain_empty_c1_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'hff10ada3d1672c5d66f1a8056d95d0f73a37888909e6d96afe133b5d5a8577adc6953299b3d960d9e08e3833ed1fd9c22ee48adbac4ad8df398bf564615e3d47);
            $finish;
        end

        $display("PASS sdmc_xof_chain_empty_c1_out64");
        $finish;
    end
