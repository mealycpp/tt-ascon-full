...
module tb_sdmc_xof_chain_empty_c2_out64;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_empty_c2_out64.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_empty_c2_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_empty_c2_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_empty_c2_out64");
            $finish;
        end
        ...
        if (got !== 512'hf7172cc68948c9f1ce569bce24d090573775ae2a525457ce651b69945b80666b726a85a6d13c3dce8335b82e5db041b9920f7601f93106c77a0d15a63c328d51) begin
            $display("FAIL digest mismatch sdmc_xof_chain_empty_c2_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'hf7172cc68948c9f1ce569bce24d090573775ae2a525457ce651b69945b80666b726a85a6d13c3dce8335b82e5db041b9920f7601f93106c77a0d15a63c328d51);
            $finish;
        end

        $display("PASS sdmc_xof_chain_empty_c2_out64");
        $finish;
    end
