...
module tb_sdmc_xof_chain_empty_c5_out16;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_empty_c5_out16.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_empty_c5_out16);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_empty_c5_out16");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_empty_c5_out16");
            $finish;
        end
        ...
        if (got !== 128'hdd590610dc23daef34fce3471cfb2f92) begin
            $display("FAIL digest mismatch sdmc_xof_chain_empty_c5_out16");
            $display("got=%h", got);
            $display("exp=%h", 128'hdd590610dc23daef34fce3471cfb2f92);
            $finish;
        end

        $display("PASS sdmc_xof_chain_empty_c5_out16");
        $finish;
    end
