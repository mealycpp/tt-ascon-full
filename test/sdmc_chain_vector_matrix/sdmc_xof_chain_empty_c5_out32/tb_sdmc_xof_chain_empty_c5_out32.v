...
module tb_sdmc_xof_chain_empty_c5_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_empty_c5_out32.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_empty_c5_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_empty_c5_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_empty_c5_out32");
            $finish;
        end
        ...
        if (got !== 256'h710a00d8a1f2225fc3e84c2d1fad5c45dd590610dc23daef34fce3471cfb2f92) begin
            $display("FAIL digest mismatch sdmc_xof_chain_empty_c5_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h710a00d8a1f2225fc3e84c2d1fad5c45dd590610dc23daef34fce3471cfb2f92);
            $finish;
        end

        $display("PASS sdmc_xof_chain_empty_c5_out32");
        $finish;
    end
