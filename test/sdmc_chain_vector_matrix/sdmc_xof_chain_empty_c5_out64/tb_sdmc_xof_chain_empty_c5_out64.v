...
module tb_sdmc_xof_chain_empty_c5_out64;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_empty_c5_out64.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_empty_c5_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_empty_c5_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_empty_c5_out64");
            $finish;
        end
        ...
        if (got !== 512'hdecba3559c4f11664c46b4897cce0d506593f3f764a2847e0dfb3ddafb00cc41710a00d8a1f2225fc3e84c2d1fad5c45dd590610dc23daef34fce3471cfb2f92) begin
            $display("FAIL digest mismatch sdmc_xof_chain_empty_c5_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'hdecba3559c4f11664c46b4897cce0d506593f3f764a2847e0dfb3ddafb00cc41710a00d8a1f2225fc3e84c2d1fad5c45dd590610dc23daef34fce3471cfb2f92);
            $finish;
        end

        $display("PASS sdmc_xof_chain_empty_c5_out64");
        $finish;
    end
