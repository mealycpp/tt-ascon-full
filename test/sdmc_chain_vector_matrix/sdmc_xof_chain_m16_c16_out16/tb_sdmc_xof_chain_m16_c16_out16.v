...
module tb_sdmc_xof_chain_m16_c16_out16;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_m16_c16_out16.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_m16_c16_out16);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_m16_c16_out16");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_m16_c16_out16");
            $finish;
        end
        ...
        if (got !== 128'h56930d135c68113419e3ce7af3636379) begin
            $display("FAIL digest mismatch sdmc_xof_chain_m16_c16_out16");
            $display("got=%h", got);
            $display("exp=%h", 128'h56930d135c68113419e3ce7af3636379);
            $finish;
        end

        $display("PASS sdmc_xof_chain_m16_c16_out16");
        $finish;
    end
