...
module tb_sdmc_xof_chain_m16_c1_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_m16_c1_out32.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_m16_c1_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_m16_c1_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_m16_c1_out32");
            $finish;
        end
        ...
        if (got !== 256'he38de498bb4cac83925865c3af1cb073df1dce7848328c1d3e2d44f6c5edbf10) begin
            $display("FAIL digest mismatch sdmc_xof_chain_m16_c1_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'he38de498bb4cac83925865c3af1cb073df1dce7848328c1d3e2d44f6c5edbf10);
            $finish;
        end

        $display("PASS sdmc_xof_chain_m16_c1_out32");
        $finish;
    end
