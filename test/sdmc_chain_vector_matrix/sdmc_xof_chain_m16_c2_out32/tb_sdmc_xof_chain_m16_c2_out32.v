...
module tb_sdmc_xof_chain_m16_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_m16_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_m16_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_m16_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_m16_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'h73a10fe16a16c9600d43404485103a18b900395f43375f2b2656a53609f6c579) begin
            $display("FAIL digest mismatch sdmc_xof_chain_m16_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h73a10fe16a16c9600d43404485103a18b900395f43375f2b2656a53609f6c579);
            $finish;
        end

        $display("PASS sdmc_xof_chain_m16_c2_out32");
        $finish;
    end
