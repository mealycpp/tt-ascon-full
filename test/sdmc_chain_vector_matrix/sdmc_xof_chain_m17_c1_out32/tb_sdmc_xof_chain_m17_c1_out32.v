...
module tb_sdmc_xof_chain_m17_c1_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_m17_c1_out32.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_m17_c1_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_m17_c1_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_m17_c1_out32");
            $finish;
        end
        ...
        if (got !== 256'h9a373a1dda28c1c5368503a45bcbc51572e571052706ae7bd99bca974ff63a23) begin
            $display("FAIL digest mismatch sdmc_xof_chain_m17_c1_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h9a373a1dda28c1c5368503a45bcbc51572e571052706ae7bd99bca974ff63a23);
            $finish;
        end

        $display("PASS sdmc_xof_chain_m17_c1_out32");
        $finish;
    end
