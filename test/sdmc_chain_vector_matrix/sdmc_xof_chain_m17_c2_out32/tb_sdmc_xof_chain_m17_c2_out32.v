...
module tb_sdmc_xof_chain_m17_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_m17_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_m17_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_m17_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_m17_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'h22e61f8234314860f63df8f1303168bd7e06b835dbab4a151f24bb62338df6bc) begin
            $display("FAIL digest mismatch sdmc_xof_chain_m17_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h22e61f8234314860f63df8f1303168bd7e06b835dbab4a151f24bb62338df6bc);
            $finish;
        end

        $display("PASS sdmc_xof_chain_m17_c2_out32");
        $finish;
    end
