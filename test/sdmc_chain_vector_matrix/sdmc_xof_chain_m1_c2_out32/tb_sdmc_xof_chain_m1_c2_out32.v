...
module tb_sdmc_xof_chain_m1_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_m1_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_m1_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_m1_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_m1_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'h0f680e41070ade8cd18c55c4c11acae3e495712fbba3807cdea0c4ea4d2dc387) begin
            $display("FAIL digest mismatch sdmc_xof_chain_m1_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h0f680e41070ade8cd18c55c4c11acae3e495712fbba3807cdea0c4ea4d2dc387);
            $finish;
        end

        $display("PASS sdmc_xof_chain_m1_c2_out32");
        $finish;
    end
