...
module tb_sdmc_xof_chain_m32_c1_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_m32_c1_out32.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_m32_c1_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_m32_c1_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_m32_c1_out32");
            $finish;
        end
        ...
        if (got !== 256'h52b0b7e0e43b0f88890eb75d4328668dcece8219b53479cc711417f403345f2e) begin
            $display("FAIL digest mismatch sdmc_xof_chain_m32_c1_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h52b0b7e0e43b0f88890eb75d4328668dcece8219b53479cc711417f403345f2e);
            $finish;
        end

        $display("PASS sdmc_xof_chain_m32_c1_out32");
        $finish;
    end
