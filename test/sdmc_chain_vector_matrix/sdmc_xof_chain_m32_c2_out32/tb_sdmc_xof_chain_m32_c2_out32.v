...
module tb_sdmc_xof_chain_m32_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_m32_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_m32_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_m32_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_m32_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'hec75bbdc542551b8c05e0ea55707b6444750f2612797597f6ce69a41b2478645) begin
            $display("FAIL digest mismatch sdmc_xof_chain_m32_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'hec75bbdc542551b8c05e0ea55707b6444750f2612797597f6ce69a41b2478645);
            $finish;
        end

        $display("PASS sdmc_xof_chain_m32_c2_out32");
        $finish;
    end
