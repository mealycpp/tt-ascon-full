...
module tb_sdmc_xof_chain_m32_c5_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_m32_c5_out32.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_m32_c5_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_m32_c5_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_m32_c5_out32");
            $finish;
        end
        ...
        if (got !== 256'h537592ed85fc099aaf90e6e4eb041b4d787e3155cf1ad3b74ae94b85ddebf3e2) begin
            $display("FAIL digest mismatch sdmc_xof_chain_m32_c5_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h537592ed85fc099aaf90e6e4eb041b4d787e3155cf1ad3b74ae94b85ddebf3e2);
            $finish;
        end

        $display("PASS sdmc_xof_chain_m32_c5_out32");
        $finish;
    end
