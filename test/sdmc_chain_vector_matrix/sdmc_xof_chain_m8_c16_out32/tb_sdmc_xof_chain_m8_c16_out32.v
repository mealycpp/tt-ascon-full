...
module tb_sdmc_xof_chain_m8_c16_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_m8_c16_out32.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_m8_c16_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_m8_c16_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_m8_c16_out32");
            $finish;
        end
        ...
        if (got !== 256'h3cd7bfddb8e97828011ef2ed7d957afccbf52a40e79c549ce5915a01d1fb1c02) begin
            $display("FAIL digest mismatch sdmc_xof_chain_m8_c16_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h3cd7bfddb8e97828011ef2ed7d957afccbf52a40e79c549ce5915a01d1fb1c02);
            $finish;
        end

        $display("PASS sdmc_xof_chain_m8_c16_out32");
        $finish;
    end
