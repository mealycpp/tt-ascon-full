...
module tb_sdmc_xof_chain_m8_c16_out64;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_m8_c16_out64.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_m8_c16_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_m8_c16_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_m8_c16_out64");
            $finish;
        end
        ...
        if (got !== 512'h5764b02ef4df46fa6c073317938da5a8c0bfdf6915ec0850578290606448f37d3cd7bfddb8e97828011ef2ed7d957afccbf52a40e79c549ce5915a01d1fb1c02) begin
            $display("FAIL digest mismatch sdmc_xof_chain_m8_c16_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'h5764b02ef4df46fa6c073317938da5a8c0bfdf6915ec0850578290606448f37d3cd7bfddb8e97828011ef2ed7d957afccbf52a40e79c549ce5915a01d1fb1c02);
            $finish;
        end

        $display("PASS sdmc_xof_chain_m8_c16_out64");
        $finish;
    end
