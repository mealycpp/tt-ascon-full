...
module tb_sdmc_xof_chain_m8_c1_out64;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_m8_c1_out64.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_m8_c1_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_m8_c1_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_m8_c1_out64");
            $finish;
        end
        ...
        if (got !== 512'h96c87fa6bd117452ee9bef739c7f06fda6620006e4f50e2a515e3cfb7d3d8051c9b6386eedb57940c3f982fb28bc91eaa64db762bc445bd1f84aecd3f586188d) begin
            $display("FAIL digest mismatch sdmc_xof_chain_m8_c1_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'h96c87fa6bd117452ee9bef739c7f06fda6620006e4f50e2a515e3cfb7d3d8051c9b6386eedb57940c3f982fb28bc91eaa64db762bc445bd1f84aecd3f586188d);
            $finish;
        end

        $display("PASS sdmc_xof_chain_m8_c1_out64");
        $finish;
    end
