...
module tb_sdmc_xof_chain_m8_c2_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_m8_c2_out32.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_m8_c2_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_m8_c2_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_m8_c2_out32");
            $finish;
        end
        ...
        if (got !== 256'h98858323eb896c913ac0f74ba457d61eb690aa432b859e37f7f8fede5a5cea1d) begin
            $display("FAIL digest mismatch sdmc_xof_chain_m8_c2_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'h98858323eb896c913ac0f74ba457d61eb690aa432b859e37f7f8fede5a5cea1d);
            $finish;
        end

        $display("PASS sdmc_xof_chain_m8_c2_out32");
        $finish;
    end
