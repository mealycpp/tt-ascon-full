...
module tb_sdmc_xof_chain_m8_c2_out64;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_m8_c2_out64.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_m8_c2_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_m8_c2_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_m8_c2_out64");
            $finish;
        end
        ...
        if (got !== 512'h141db931a87348dc70cd016868601746437ff9acc431745b9ff99f4b6da65a2d98858323eb896c913ac0f74ba457d61eb690aa432b859e37f7f8fede5a5cea1d) begin
            $display("FAIL digest mismatch sdmc_xof_chain_m8_c2_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'h141db931a87348dc70cd016868601746437ff9acc431745b9ff99f4b6da65a2d98858323eb896c913ac0f74ba457d61eb690aa432b859e37f7f8fede5a5cea1d);
            $finish;
        end

        $display("PASS sdmc_xof_chain_m8_c2_out64");
        $finish;
    end
