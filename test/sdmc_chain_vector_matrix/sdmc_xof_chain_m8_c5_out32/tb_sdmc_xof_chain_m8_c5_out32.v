...
module tb_sdmc_xof_chain_m8_c5_out32;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_m8_c5_out32.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_m8_c5_out32);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_m8_c5_out32");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_m8_c5_out32");
            $finish;
        end
        ...
        if (got !== 256'hc5c5ec954092440787d0487b8783e2ed1956b187b410901d532e284c517bd1ee) begin
            $display("FAIL digest mismatch sdmc_xof_chain_m8_c5_out32");
            $display("got=%h", got);
            $display("exp=%h", 256'hc5c5ec954092440787d0487b8783e2ed1956b187b410901d532e284c517bd1ee);
            $finish;
        end

        $display("PASS sdmc_xof_chain_m8_c5_out32");
        $finish;
    end
