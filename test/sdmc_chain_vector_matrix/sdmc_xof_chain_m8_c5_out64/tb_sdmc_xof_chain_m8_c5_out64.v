...
module tb_sdmc_xof_chain_m8_c5_out64;
    ...
    initial begin
        $dumpfile("tb_sdmc_xof_chain_m8_c5_out64.vcd");
        $dumpvars(0, tb_sdmc_xof_chain_m8_c5_out64);
        ...
        while (!done) begin
            ...
            if (guard > 200000) begin
                $display("FAIL timeout sdmc_xof_chain_m8_c5_out64");
                $finish;
            end
        end
        ...
        if (error) begin
            $display("FAIL error asserted sdmc_xof_chain_m8_c5_out64");
            $finish;
        end
        ...
        if (got !== 512'h2bd13d38e3d9af8a9445213f4644ce20b21630f0a9188b2c87e9f511f43ad0d8c5c5ec954092440787d0487b8783e2ed1956b187b410901d532e284c517bd1ee) begin
            $display("FAIL digest mismatch sdmc_xof_chain_m8_c5_out64");
            $display("got=%h", got);
            $display("exp=%h", 512'h2bd13d38e3d9af8a9445213f4644ce20b21630f0a9188b2c87e9f511f43ad0d8c5c5ec954092440787d0487b8783e2ed1956b187b410901d532e284c517bd1ee);
            $finish;
        end

        $display("PASS sdmc_xof_chain_m8_c5_out64");
        $finish;
    end
