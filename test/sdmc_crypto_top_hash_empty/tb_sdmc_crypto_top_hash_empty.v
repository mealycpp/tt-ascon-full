...
module tb_sdmc_crypto_top_hash_empty;
    ...
    initial begin
        $dumpfile("tb_sdmc_crypto_top_hash_empty.vcd");
        $dumpvars(0, tb_sdmc_crypto_top_hash_empty);
        ...
        // CFG_MODE = HASH
        cfg_write(4'd0, {60'd0, `SDMC_HOST_HASH});

        // CFG_LEN0: msg_len=0, cs_len=0, ad_len=0, out_len=32
        cfg_write(4'd1, {16'd32, 16'd0, 16'd0, 16'd0});
        ...
        $display("PASS sdmc_crypto_top_hash_empty");
        $finish;
    end
