...
module tb_sdmc_cxof_chain_family_core;
    ...
    initial begin
        $dumpfile("tb_sdmc_cxof_chain_family_core.vcd");
        $dumpvars(0, tb_sdmc_cxof_chain_family_core);
        ...
        if (digest !== 256'hc25576f019ac26c54c84b50fc73771cf4de2512b13f80d1eb0c372a1695444b5) begin
            $display("FAIL digest mismatch");
            $display("got=%h", digest);
            $display("exp=%h", 256'hc25576f019ac26c54c84b50fc73771cf4de2512b13f80d1eb0c372a1695444b5);
            $finish;
        end

        $display("PASS sdmc_cxof_chain_family_core");
        $finish;
    end
